...
import { Clock, LogOut, LayoutDashboard, Users, CalendarCheck, FileText, Code2, Settings, Building2, ClipboardList, CalendarDays, Shield } from 'lucide-react';
...
export default function AdminLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 flex">
      {/* Sidebar */}
      <aside className="w-64 bg-[#1E3A5F] text-white flex flex-col min-h-screen shrink-0">
